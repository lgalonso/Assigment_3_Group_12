...
//    private String[] video_ids = {"uUKAYkQZXko", "-d-fF1Nx2bQ", "HgJ2tFT-au0", "UBMk30rjy0o", "W273f7MYt2Y"};
    ...
    private String[] abs_images = {"Push up", "Sit up", "T-Cross sit up"};
...
//    private String[] arms_images = {"", "", "", ""};
    ...
    private String[] legs_images = {"leg lift", "Lunge", "Squat"};
    ...
    private String[] full_body_images = {"bike", "Lunge with dumbbell", "treadmill"};
